...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-indigo-50/30 to-white">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-indigo-50/30 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              <span className="text-sm px-4 py-2 bg-yellow-100 text-yellow-700 rounded-full font-semibold">
                Pricing Plans
              </span>
            </div>
            <h2 className="text-5xl font-extrabold text-gray-900 mb-4">Affordable & Transparent</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card 
                ...
                className={`relative transform transition-all duration-500 hover:scale-105 ${
                  plan.popular 
                    ...
                    : 'border-2 border-gray-200 hover:border-indigo-300 shadow-lg'
                }`}
              ...
              >
                ...
                {!plan.available && (
                  <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gray-500 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg">
                      Coming Soon
                    </span>
                  </div>
                )}
